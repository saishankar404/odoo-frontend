...
import { Plus, MoreHorizontal, User, X, Trash2, Edit, Copy, ChevronLeft, ChevronRight } from "lucide-react"
                          ...
                          {columnOrder.map((columnId) => (
                            ...
                            >
                              {columnTitles[columnId as keyof typeof columnTitles] ||
                                (columnId ? columnId.replace("-", " ").replace(/\b\w/g, (l) => l.toUpperCase()) : 'Unknown')}
                            </SelectItem>
                          ))}
                        </SelectContent>
                      </Select>
                ...
                <Kanban.Column key={columnId} value={columnId} className="flex-shrink-0 w-80">
                  <Card className="h-full bg-neutral-900 border-neutral-800 shadow-lg">
                    <CardHeader className="pb-3 bg-neutral-900 border-b border-neutral-800">
                      <div className="flex items-center justify-between">
                        <CardTitle className="text-sm font-medium flex items-center gap-2 text-neutral-50">
                          {columnTitles[columnId as keyof typeof columnTitles] ||
                            (columnId ? columnId.replace("-", " ").replace(/\b\w/g, (l) => l.toUpperCase()) : 'Unknown')}
                          <Badge
                            variant="secondary"
                        ...
                        <div className="flex gap-1">
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => moveColumnLeft(columnId)}
                            disabled={columnOrder.indexOf(columnId) === 0}
                            className="text-neutral-400 hover:text-neutral-50 hover:bg-neutral-800 disabled:opacity-30 disabled:cursor-not-allowed"
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => moveColumnRight(columnId)}
                            disabled={columnOrder.indexOf(columnId) === columnOrder.length - 1}
                            className="text-neutral-400 hover:text-neutral-50 hover:bg-neutral-800 disabled:opacity-30 disabled:cursor-not-allowed"
